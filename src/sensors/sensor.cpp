...
static AcPzem acInputPzem(AC_INPUT_SENSOR_NAME, acPzemSerial, AC_INPUT_SENSOR_ADDRESS, AC_INPUT_PZEM_ADDRESS);
static AcPzem acOutputPzem(AC_OUTPUT_SENSOR_NAME, acPzemSerial, AC_OUTPUT_SENSOR_ADDRESS, AC_OUTPUT_PZEM_ADDRESS);
