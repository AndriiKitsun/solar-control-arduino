// SoftwareSerial pzemSWSerial(AC_PZEM_RX_PIN, AC_PZEM_TX_PIN);

// PZEM004Tv30 inputAcPzem(pzemSWSerial, AC_INPUT_PZEM_ADDRESS);
// PZEM004Tv30 outputAcPzem(pzemSWSerial, AC_OUTPUT_PZEM_ADDRESS);
